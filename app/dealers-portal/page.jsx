...
export const metadata = {
  title:
    "Dealer Portal | BMR Suspension | Performance Suspension & Chassis Parts",
  description:
            ...
            <div className="col-12">
              <div className="text-center" style={{ padding: "60px 20px" }}>
                ...
                <p className="lead mb-4">
                  We're working hard to bring you an exclusive dealer portal
                  with special pricing, order management, and more.
                </p>
                <p>
