...
import { getFordPlatformsWithVehicles } from "@/lib/queries";

export const dynamic = "force-dynamic";

export default async function FordPage() {
  const platforms = await getFordPlatformsWithVehicles();

  return (
    <div className="container pt-3 pb-5" style={{ minHeight: "60vh" }}>
      <div className="text-center">
        <h1 className="home-title d-inline-block" style={{ lineHeight: "30px", marginTop: "30px" }}>Ford Platforms</h1>
      </div>

      <p className="text-center text_black-2 mt-1 mb-5">
        Explore every Ford platform we support. Click a platform to shop parts.
      </p>
