		...
		<div className="admin-dashboard">
			...
			<div className="admin-stats-grid">
				...
				<div className="admin-stat-card">
					...
					<div className="admin-stat-value text-warning">{stats.pendingOrders}</div>
				...
				<div className="admin-stat-card">
					...
					<div className="admin-stat-value text-info">{stats.processedOrders}</div>
					<Link
				...
				<div className="admin-stat-card">
					...
					<div className="admin-stat-value text-success">{stats.shippedOrders}</div>
				...
				<div className="admin-stat-card">
					...
					<div className="admin-stat-value text-success">{stats.activeCoupons}</div>
					<Link href="/admin/coupons" className="admin-stat-link">
						Manage coupons →
					</Link>
				</div>
