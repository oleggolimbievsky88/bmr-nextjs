...
export default async function page() {
  ...
  const privacyHtml = sanitizeRichTextHtml(legal.privacyPolicyHtml || "");
  const hasCustom = Boolean(privacyHtml && privacyHtml.trim());
  const companyName = brand?.companyName || brand?.name || "BMR Suspension";
          ...
          <div className="privacy-policy-page__grid">
            {hasCustom ? (
              <article className="privacy-policy-page__card">
                ...
                <div
                  className="privacy-policy-page__rich"
              ...
              <>
                ...
                <article className="privacy-policy-page__card">
                  ...
                  <p className="privacy-policy-page__text">
                    ...
                    from our store. Your privacy is very important to us.
                    Accordingly, we have developed this Policy in order for you
                    to understand how we collect, use, communicate, disclose,
                    and make use of personal information. The following outlines
                    our privacy policy.
                  </p>
                </article>
                ...
                <article className="privacy-policy-page__card">
                  ...
                  <ul className="privacy-policy-page__list">
                    <li>
                      ...
                      we will identify the purposes for which information is
                      being collected.
                    </li>
                    <li>
                      We will collect and use personal information solely with
                      the objective of fulfilling those purposes specified by us
                      and for other compatible purposes, unless we obtain the
                ...
                <article className="privacy-policy-page__card">
                  ...
                  <ul className="privacy-policy-page__list">
                    <li>
                      Process your transactions and provide customer service.
                    </li>
                    <li>
                      Send you a newsletter, if you have subscribed to one.
                    </li>
