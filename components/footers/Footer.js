              ...
              <div className="footer__widget">
                ...
                <div className="footer__widget--inner">
                  <p className="footer__widget--desc">
                    <b>BMR Suspension</b> Manufactures Quality Heavy Duty Performance Control Arms, Panhard Bars, Shock Tower Braces, K-Members, Lowering Spring Kits, CV Axle Shafts, A-Arms, Trailing Arms, Sway Bars, Anti-Roll Bar Kits, Toe Rods, Driveshaft Safety Loops and much more.
                  </p>
        ...
        <div className="container">
          <div className="footer__bottom--inenr d-flex justify-content-between align-items-center">
            ...
            <p className="copyright__content">
              <span className="text__secondary">© 2024</span> BMR Suspension.
              All Rights Reserved.
            </p>
