...
const buildAddressLines = (profile, type) => {
	...
	const firstName = isShipping
		? profile.shippingfirstname
		: profile.firstname
	const lastName = isShipping
		? profile.shippinglastname
		: profile.lastname
	const address1 = isShipping
		? profile.shippingaddress1
		: profile.address1
	const address2 = isShipping
