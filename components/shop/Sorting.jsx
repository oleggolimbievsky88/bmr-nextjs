...
export default function Sorting({ products = [], setFinalSorted = () => [] }) {
  ...
  // IMPORTANT: setFinalSorted should be memoized in the parent using useCallback to avoid infinite loops.
  useEffect(() => {
    let sorted = [...products];
    ...
    // Only update if different (shallow compare by stringifying)
    setFinalSorted((prev) => {
