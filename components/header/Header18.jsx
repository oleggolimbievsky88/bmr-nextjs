...
export default function Header18({ showVehicleSearch = true }) {
  ...
  return (
    ...
    >
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap">
            <div className="d-flex align-items-center gap-3">
              <a
                ...
                className="btn-mobile text-white"
              >
                <svg
            ...
            <ul className="nav-icon d-flex align-items-center gap-20">
              <li className="nav-search tf-lg-hidden">
                <a
                  href="#canvasSearch"
                  data-bs-toggle="offcanvas"
                  aria-controls="offcanvasLeft"
      ...
      <div className="header-bottom line-red-2 hidden-xl bg_black">
        <div className="container">
        ...
        {showVehicleSearch && (
          <div className="header-vehicle-row">
            <div className="container">
              <VehicleSearch />
            </div>
          </div>
