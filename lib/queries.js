...
export async function getNewProducts() {
  const [rows] = await pool.query(`
    SELECT p.*, CONCAT(b.StartYear, '-', b.EndYear) as YearRange, b.Name as PlatformName FROM bmrsuspension.products p
...
export async function fetchSubCategories(mainCategoryId) {
