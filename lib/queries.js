 ...
 * Returns ProductID, PartNumber, ProductName, Price, ImageSmall, ImageLarge, BodyID.
 */
...
export async function getProductsForDealerCount(search = null) {
  try {
    let sql = `
