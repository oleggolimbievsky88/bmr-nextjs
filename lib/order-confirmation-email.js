 ...
 * Matches the order confirmation page design with BMR-Logo.webp at top.
...
export function generateOrderConfirmationHTML(orderData) {
  ...
  const logoUrl = `${base}/images/logo/BMR-Logo.webp`;
      ...
      <div class="email-wrapper">
        <div class="email-container">
          <div class="receipt-header">
            <img src="${logoUrl}" alt="BMR Suspension" width="320" height="137" />
          </div>
