...
const PLATFORM_IMAGE_BASE =
  process.env.NEXT_PUBLIC_PLATFORM_IMAGE_BASE_URL || "/siteart/cars";
const PLATFORM_BANNER_BASE =
  process.env.NEXT_PUBLIC_PLATFORM_BANNER_BASE_URL ||
