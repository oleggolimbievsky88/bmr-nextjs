...
export const gmLateModelLinks = [
  {
    heading: "Late Model Cars",
    links: [
      { href: "/platform/2014-2019-corvette", text: "2014 - 2019 Corvette" },
      { href: "/platform/2005-2013-corvette", text: "2005 - 2013 Corvette" },
      { href: "/platform/1997-2004-corvette", text: "1997 - 2004 Corvette" },
      { href: "/platform/2016-2024-camaro", text: "2016 - 2024 Chevy Camaro" },
      { href: "/platform/2010-2015-camaro", text: "2010 - 2015 Chevy Camaro" },
      { href: "/platform/2008-2009-g8", text: "2008 - 2009 Pontiac G8" },
      { href: "/platform/2004-2006-gto", text: "2004 - 2006 Pontiac GTO" },
    ],
  },
];

export const gmMidMuscleLinks = [
  {
    heading: "Mid Muscle Cars",
    links: [
      { href: "/platform/1975-1979-x-body", text: "1975 - 1979 X-Body" },
      { href: "/platform/1982-1992-f-body", text: "1982 - 1992 F-Body" },
      { href: "/platform/1991-1996-b-body", text: "1991 - 1996 B-Body" },
      { href: "/platform/1978-1987-g-body", text: "1978 - 1987 G-Body" },
    ],
  },
];

export const gmClassicMuscleLinks = [
  {
    heading: "Classic Muscle Cars",
    links: [
      { href: "/platform/1970-1981-f-body", text: "1970 - 1981 F-Body" },
      { href: "/platform/1967-1969-f-body", text: "1967 - 1969 F-Body" },
      { href: "/platform/1964-1972-a-body", text: "1964 - 1972 A-Body" },
    ],
  },
];
